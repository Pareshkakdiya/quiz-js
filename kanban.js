import Kanban from "./kanbanClass.js";

//console.log(Kanban.insertTask(0,"Edit Kanban Project Lectures"));
// console.log(Kanban.getTask(1));
// Kanban.deleteTask(1675);
// console.log(Kanban.getTask(1));

// console.log(Kanban.getAllTasks());
// Kanban.updateTask(1675, {
//     columnId:1,
//     content:'Edit Kanban Project'
// });
// console.log(Kanban.getAllTasks());
